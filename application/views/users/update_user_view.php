...
<div class="title_pages">
    <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Editar usuário
    </div>
    ...
    <input type="hidden" name="id" value="<?= $users->id ?>">
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input type="text" value="<?= $users->name ?>" name="name" class="form-control" placeholder="Digite o nome">
            </div>
            <div class="form-group col-md-4">
                <label><span class="text-danger">*</span> Usuário no LDAP</label>
                <input type="text" value="<?= $users->user_ldap ?>" name="user_ldap" class="form-control" placeholder="Digite o usuário conforme o LDAP">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="row">
            <div class="form-group col-md-3">
                <input id="user_inactive" type="checkbox" value="<?= $users->status ?>" name="status"> <label for="user_inactive">Usuário inativo</label>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
        ...
        <a href="<?= base_url('users/get_user') ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
    </form>
</div>